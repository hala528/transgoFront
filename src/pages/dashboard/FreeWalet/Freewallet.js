...
export default function FreeWallet() {
  ...
  return (
    <div className="w-100 p-2">
      <h2 style={{ color: "white" }}>
        {t("freeWallet.pageTitle")}
      </h2>
        <p className="subtitle" style={{fontSize:'20px'}}>{t("freeWallet.instructions")}</p>
        <div className="cards">
        <div className="card-wallet">
          <div className="icon-circle purple">
            <FontAwesomeIcon icon={faSearch} />
          </div>
          <h5 style={{color:'white'}}>{t("freeWallet.chooseDriver")}</h5>
          <p className="subtitle">{t("freeWallet.chooseDriverDesc")}</p>
        </div>
        ...
        <div className="card-wallet">
          ...
          <h5 style={{color:'white'}}>{t("freeWallet.enterAmount")}</h5>
          <p className="subtitle">{t("freeWallet.enterAmountDesc")}</p>
        </div>
        ...
        <div className="card-wallet">
          ...
          <h5 style={{color:'white'}}>{t("walletDriver.confirm")}</h5>
            <p className="subtitle">{t("freeWallet.confirmDesc")}</p>
        </div>
        ...
        <div className="card-wallet">
          ...
          <h5 style={{color:'white'}}>{t("freeWallet.notify")}</h5>
            <p className="subtitle">{t("freeWallet.notifyDesc")}</p>
        </div>
        <Link to={`to={'wallet.id'}`}>
         <div className="card-click">
          ...
          <h5 style={{color:'#cbd5f5'}}>{t("freeWallet.clickToSeeHistory")}</h5>
        </div>
        </Link>
       ...
       <div className="card-items">
        <FontAwesomeIcon color="white" icon={faBullhorn} />
         <p className="subtitle" style={{fontSize:'15px'}}>{t("freeWallet.chargeDriverIntro")}</p>
         <Link to="/dashboard/wallet/chargedriver/123">
         <p className="subtitle" style={{
            color:'blue',
            fontSize:'15px'
         }}>  {t("freeWallet.clickHere")}</p>
          </Link>
       </div>
        <div className="card-items">
            <FontAwesomeIcon color="white" icon={faBullhorn} />
        
         <p className="subtitle" style={{fontSize:'15px'}}>{t("freeWallet.chargePassengerIntro")}</p>
         <Link to="/dashboard/wallet/chargepassenger">
         <p className="subtitle" style={{
            color:'blue',
            fontSize:'15px'
