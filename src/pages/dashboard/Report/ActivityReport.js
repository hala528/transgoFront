...
function ActivityReport() {
  ...
  const stats = [
    {
      title: t("activityReport.totalTrips"),
      value:
        summary.total_trips || 0,
    ...
    {
      title: t("activityReport.pending"),
      value:
        summary.pending_trips || 0,
      desc: t("activityReport.pendingTrips"),
      icon: (
        <Clock3 size={20} />
      ),
      color: "orange",
    ...
    {
      title: t("activityReport.active"),
      value:
        summary.active_trips || 0,
      desc: t("activityReport.activeTrips"),
      icon: <Play size={20} />,
      color: "green",
    },

    {
      ...
      value:
        summary.completed_trips || 0,
      desc: t("activityReport.completedTrips"),
      icon: (
        <CheckCircle2 size={20} />
      ),
      color: "blue",
    ...
    {
      title: t("activityReport.cancelled"),
      value:
        summary.canceled_trips || 0,
      desc: t("activityReport.cancelledTrips"),
      icon: (
        <XCircle size={20} />
      ),
      color: "red",
    ...
    {
      title: t("activityReport.bookingsCount"),
      value:
        summary.bookings_count || 0,
      desc: t("activityReport.totalBookings"),
      icon: <Users size={20} />,
      color: "purple",
    },
  ...
  return (
    <>
      ...
      <div className="filters">
        ...
        <FilterInput
          label={t("activityReport.startGovernorate")}
          type="select"
          value={
            filters.start_governorate_id
          }
        ...
        <FilterInput
          label={t("activityReport.endGovernorate")}
          type="select"
          value={
            filters.end_governorate_id
          }
...
<div className="table-box">
  <div className="table-header">
    <h3>
      {t("activityReport.startGovernoratesActivity")}
    </h3>
  </div>
  ...
  <table>
    <thead>
       <tr>
        <th>#</th>
        <th>{t("activityReport.governorate")}</th>
        ...
        <th>{t("activityReport.cancelled")}</th>
        <th>{t("activityReport.bookings")}</th>
        <th>{t("activityReport.activity")}</th>
      </tr>
    </thead>
 ...
 <td>
  ...
  <div className="table-header">
    <h3>
      {t("activityReport.endGovernoratesActivity")}
    </h3>
  </div>
